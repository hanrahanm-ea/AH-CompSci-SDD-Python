...
# Complete this file using a fixed-size array of Event objects.
...
class Manager(Employee):
    ...
    def get_info(self):
        parent_info = super().get_employment_info()  # Call parent's get_info()
        return f"{parent_info}\nManaging {self.__teamsize} employees\nBudget: ${self.__budget:,.2f}"
...
item1 = Employee("01", "Max", "H", "3000", "Computing", "Head", "26/08/18")
item2 = Employee("02", "Dultach", "H", "3000", "Statistics", "Intern", "26/08/26")
item3 = Employee("03", "Micheal", "H", "3000", "Maths", "Employee", "26/08/19")
item4 = Employee("04", "Sami", "H", "3000", "Physics", "Employee", "26/08/15")
item5 = Employee("05", "Yu-wen", "H", "3000", "Research", "Employee", "26/08/23")
item6 = Employee("06", "Gordon", "H", "3000", "Computing", "Employee", "26/08/24")
item7 = Manager("02", "M", "H", "400000", "Managerial", "Head Manager", "25/02/13", team_size = 5, budget = 3000)
array_employees = [None] * 10
array_employees[0] = item1
array_employees[1] = item2
array_employees[2] = item3
array_employees[3] = item4
array_employees[4] = item5
array_employees[5] = item6
array_employees[6] = item7
information = array_employees[6].get_info()
print(information)
information = array_employees[6].get_annual_salary()
print(information)
